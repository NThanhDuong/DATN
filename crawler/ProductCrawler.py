...
def process_product_by_link(info: dict):
    ...
    df_pro.to_csv(f'C:/D/Doan/data-platform/data/dataRawNew/{info["url_key"]}-{info["query_value"]}.csv')
    print(f'Success to save ./dataRawNew/{info["url_key"]}.csv')
...
if __name__ == "__main__":
    df_link = pd.read_csv("C:\D\Doan\data-platform\data\link_category2.csv")
